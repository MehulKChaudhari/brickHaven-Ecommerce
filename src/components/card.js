...
export const Card = ({ id, name, image, price, brand }) => {
    const router = useRouter();
    const onClick = () => {
        router.push("/cart");
    }
  return (
      <div class="bg-white shadow-md hover:scale-105 hover:shadow-xl duration-500" key={id}>
        <a href="#">
          <img src={image} alt={name} class="h-80 w-72 object-cover" />
        </a>
